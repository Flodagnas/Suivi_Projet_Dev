...
def SignUp():
    ...
    boutRetour1 = Button(fenetre,text='Retour', width =11, command=retourSignUp, font=ftComic,bg="#D1D1D1",fg="#AA0000")
    boutRetour1.grid (row =15,column =6, padx = 10,pady = 10, columnspan =3)
